        ...
        ### Derived from [qdhenry/Claude-Command-Suite](https://github.com/qdhenry/Claude-Command-Suite)
        ...
        > **Adaptation of `qdhenry/Claude-Command-Suite` for Data Science & AI/ML use cases.**
        > Source focus: _216 commands, 12 skills, 54 agents, structured workflows_
        ...
        **5 multi-step workflows**, all with a consistent
        ...
        ```bash
        # Clone this skill
        cp -r . ~/.claude/skills/r00-qdhenry-Claude-Command-Suite--datascience/

        # Register in Claude Code
        # In a Claude Code session:
        /read ~/.claude/skills/r00-qdhenry-Claude-Command-Suite--datascience/SKILL.md
        ```
...
```
        ...
        **[qdhenry/Claude-Command-Suite](https://github.com/qdhenry/Claude-Command-Suite)**
        which focuses on: _216 commands, 12 skills, 54 agents, structured workflows_.
